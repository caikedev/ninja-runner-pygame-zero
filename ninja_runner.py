...
def update():
	...
	if runner.image == 'run__000':
		...
		runner.image == 'run__003'
	elif runner.image == 'run__003':
		runner.image == 'run__004'
	elif runner.image == 'run__004':
		runner.image == 'run__005'
	elif runner.image == 'run__005':
		runner.image == 'run__006'
	elif runner.image == 'run__006':
		runner.image == 'run__007'
	elif runner.image == 'run__007':
		runner.image == 'run__008'
	elif runner.image == 'run__008':
		runner.image == 'run__009'
	elif runner.image == 'run__009':
	...
	for actor in obstacles:
		...
		if game_over == False and actor.x < -50:
